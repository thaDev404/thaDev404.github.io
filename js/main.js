$(function(){
    ...
    */
    document.getElementById('preview-canvas').addEventListener('click', function(evt) {
        ...
        document.getElementById('img01').src = base64image;
        document.getElementById('caption').innerHTML = 'Design Canvas Download Preview';
        document.getElementById('color-wheel-center').style.display= "none";
        });
    });
   ...
   // When the user clicks on <span> (x), close the modal
    document.getElementById('close-modal').addEventListener('click', function(evt){
        ...
        document.getElementById('color-wheel-center').style.display= "initial";
    });
